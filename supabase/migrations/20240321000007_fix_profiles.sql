...
DROP TABLE IF EXISTS establishment_profiles CASCADE;

-- Create doctor_profiles table with correct structure
...
-- Create establishment_profiles table with correct structure
