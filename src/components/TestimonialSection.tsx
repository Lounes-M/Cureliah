...
const TestimonialSection = () => {
  ...
  // Testimonials data enrichie
  const mainTestimonials = [
    {
      id: 1,
      text: "Cureliah a révolutionné ma pratique libérale. En tant que cardiologue, je peux maintenant optimiser mon planning et augmenter mes revenus de 30%. La plateforme est intuitive et les établissements me contactent directement. Plus besoin de prospection !",
    ...
    {
      id: 2,
      text: "Enfin une solution qui comprend les contraintes des établissements ! Nous trouvons des médecins qualifiés en moins de 2 minutes, même pour les urgences. Le système de contrats automatiques nous fait économiser 15h par semaine.",
      author: "Sophie Martin",
      role: "Directrice",
      location: "Clinique Saint-Louis • Lyon",
      memberSince: "1 an",
      avatar: "👩‍💼",
      rating: 5,
      specialty: "Direction",
    ...
    {
      id: 3,
      text: "La qualité des médecins sur Cureliah est exceptionnelle. Tous sont vérifiés et réactifs. En tant qu'urgentiste, j'apprécie particulièrement la flexibilité et les tarifs transparents. C'est un game-changer pour notre profession.",
      author: "Dr. Jean Moreau",
      role: "Médecin urgentiste",
      location: "CHU de Bordeaux",
      memberSince: "6 mois",
      avatar: "👨‍⚕️",
      rating: 5,
      specialty: "Urgences",
  ...
  const miniTestimonials = [
    {
      id: 1,
      author: "Clinique Saint-Antoine",
      role: "Établissement de santé",
      text: "Nous trouvons maintenant des remplaçants en urgence. Le gain de temps est considérable !",
      avatar: "🏥",
      rating: 5,
      type: "establishment",
    },
    {
      ...
      author: "Dr. Lisa Chen",
      role: "Radiologue",
      text: "Interface claire, paiements rapides. Exactement ce qu'il fallait au secteur médical.",
      avatar: "👩‍⚕️",
      rating: 5,
      type: "doctor",
    },
    {
      id: 3,
      author: "MedTech Innovation",
      role: "Startup santé",
      text: "Parfait pour nos consultations ponctuelles. Les médecins sont qualifiés et réactifs.",
      avatar: "🚀",
      rating: 4,
      type: "startup",
    },
    {
      id: 4,
      author: "Dr. Paul Durand",
      role: "Anesthésiste",
      text: "Liberté totale dans la gestion de mon planning. Mes revenus ont augmenté de 25%.",
      avatar: "👨‍⚕️",
      rating: 5,
      type: "doctor",
    },
    {
      id: 5,
      author: "Centre Médical Voltaire",
      role: "Groupe médical",
