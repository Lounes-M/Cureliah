        ...
        <div className="bg-blue-50 rounded-lg p-3 mb-3">
          <div className="text-center">
            <button
              ...
              className="inline-flex items-center space-x-2 bg-blue-600 text-white px-3 py-2 rounded-lg font-mono font-bold text-sm hover:bg-blue-700 transition-colors"
            >
